...
While the intent of the use case technique is clear, it requires some discipline and
...
an overview of the processing steps.  In *W*’s
...
to separate what could *possibly*
be implemented in software from what must *minimally*
...
to determine the actual business value of a use case.  In *H*'s
...
sequence.  In both *W*'s and *H*'s cases, early proof-of-concept thinking dominated the
implementation.
...
The **Stepping In Sequence**  problem appears to stem from a
...
The **Free-Running Imagination**  problem appears to stem from a
...
The **Follow the Precedent**  problem appears to stem from an
...
I feel that a business analyst should (1) help users identify the indirect or
